        ...
        <div className="mt-20 flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1  gap-8 md:grid-cols-5 lg:grid-cols-3">
            ...
            <Card className="h-[320px] p-0 relative md:col-span-2 lg:col-span-1">
              ...
              />
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 size-20 rounded-full bg-gradient-to-r from bg-emerald-300 to-sky-400  after:content-[''] after:absolute after:inset-0 after:outline-0 after:outline after-outline-2 after:-outline-offset-2 after:rounded-full after:outline-gray-950/30">
                <Image
                  src={smileMemoji}
                  alt="smiling imoji"
                  className="size-20"
